 ...
 */
export const getAuthRegistrationStatus = <ThrowOnError extends boolean = false>(options?: Options<GetAuthRegistrationStatusData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAuthRegistrationStatusResponses, GetAuthRegistrationStatusErrors, ThrowOnError>({
        responseType: 'json',
 ...
 */
export const getSettingsRegistration = <ThrowOnError extends boolean = false>(options?: Options<GetSettingsRegistrationData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetSettingsRegistrationResponses, GetSettingsRegistrationErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'Authorization',
 ...
 */
export const putSettingsRegistration = <ThrowOnError extends boolean = false>(options: Options<PutSettingsRegistrationData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutSettingsRegistrationResponses, PutSettingsRegistrationErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'Authorization',
 ...
 */
export const patchUsersByIdActive = <ThrowOnError extends boolean = false>(options: Options<PatchUsersByIdActiveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<PatchUsersByIdActiveResponses, PatchUsersByIdActiveErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'Authorization',
