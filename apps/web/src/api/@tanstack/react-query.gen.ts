...
export const getAuthRegistrationStatusQueryKey = (options?: Options<GetAuthRegistrationStatusData>) => createQueryKey('getAuthRegistrationStatus', options);

/**
 * Get public registration status (no auth required)
 */
export const getAuthRegistrationStatusOptions = (options?: Options<GetAuthRegistrationStatusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getAuthRegistrationStatus({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getAuthRegistrationStatusQueryKey(options)
    });
};
...
export const getSettingsRegistrationQueryKey = (options?: Options<GetSettingsRegistrationData>) => createQueryKey('getSettingsRegistration', options);

/**
 * Get registration enabled status
 */
export const getSettingsRegistrationOptions = (options?: Options<GetSettingsRegistrationData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getSettingsRegistration({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getSettingsRegistrationQueryKey(options)
    });
};
 ...
 */
export const putSettingsRegistrationMutation = (options?: Partial<Options<PutSettingsRegistrationData>>): UseMutationOptions<PutSettingsRegistrationResponse, AxiosError<PutSettingsRegistrationError>, Options<PutSettingsRegistrationData>> => {
    const mutationOptions: UseMutationOptions<PutSettingsRegistrationResponse, AxiosError<PutSettingsRegistrationError>, Options<PutSettingsRegistrationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await putSettingsRegistration({
                ...options,
                ...localOptions,
                throwOnError: true
            });
 ...
 * Create a new admin user
 */
export const postUsersMutation = (options?: Partial<Options<PostUsersData>>): UseMutationOptions<PostUsersResponse, AxiosError<PostUsersError>, Options<PostUsersData>> => {
    const mutationOptions: UseMutationOptions<PostUsersResponse, AxiosError<PostUsersError>, Options<PostUsersData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postUsers({
                ...options,
                ...localOptions,
 ...
 */
export const deleteUsersByIdMutation = (options?: Partial<Options<DeleteUsersByIdData>>): UseMutationOptions<DeleteUsersByIdResponse, AxiosError<DeleteUsersByIdError>, Options<DeleteUsersByIdData>> => {
    const mutationOptions: UseMutationOptions<DeleteUsersByIdResponse, AxiosError<DeleteUsersByIdError>, Options<DeleteUsersByIdData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const patchUsersByIdActiveMutation = (options?: Partial<Options<PatchUsersByIdActiveData>>): UseMutationOptions<PatchUsersByIdActiveResponse, AxiosError<PatchUsersByIdActiveError>, Options<PatchUsersByIdActiveData>> => {
    const mutationOptions: UseMutationOptions<PatchUsersByIdActiveResponse, AxiosError<PatchUsersByIdActiveError>, Options<PatchUsersByIdActiveData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await patchUsersByIdActive({
                ...options,
                ...localOptions,
                throwOnError: true
            });
 ...
 */
export const putUsersByIdPasswordMutation = (options?: Partial<Options<PutUsersByIdPasswordData>>): UseMutationOptions<PutUsersByIdPasswordResponse, AxiosError<PutUsersByIdPasswordError>, Options<PutUsersByIdPasswordData>> => {
    const mutationOptions: UseMutationOptions<PutUsersByIdPasswordResponse, AxiosError<PutUsersByIdPasswordError>, Options<PutUsersByIdPasswordData>> = {
        mutationFn: async (localOptions) => {
