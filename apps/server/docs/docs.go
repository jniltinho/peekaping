...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/utils.ApiResponse-auth_RegistrationStatusResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.RegistrationStatusDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/users": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/utils.ApiResponse-array_auth_Model"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create admin data",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.CreateAdminDto"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/utils.ApiResponse-auth_Model"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.SetActiveDto"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "utils.ApiResponse-array_auth_Model": {
            "type": "object",
            "required": [
                "data",
                "message"
        ...
        "utils.ApiResponse-auth_RegistrationStatusResponse": {
            "type": "object",
            "required": [
                "data",
                "message"
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/auth.RegistrationStatusResponse"
                },
                "message": {
                    "type": "string"
                }
